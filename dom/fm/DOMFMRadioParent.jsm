...
this.DOMFMRadioParent = {
  ...
  _printState: function() {
    debug('disabing: ' + this._disabling + ", enabling: " + this._enabling +
          ', _isEnabled: ' + this._isEnabled);
  },

  _disableFMRadio: function(msg) {
    debug("Disable FM Radio");
    this._printState();
